        ...
        for (let i = 0; i < xlData.length; i++) {
            ...
            switch (element.Keyword) {
                ...
                case "doubleClick": //t.doubleClick( selector [, options] )
                    await t[element.Keyword](element.LocatorType(element.LocatorValue))
                    logger.info(element.Keyword + element.LocatorType + element.LocatorValue +" - After test execution, actual test result should be doubleClicked")
                    break;
                case "rightClick": //t.rightClick( selector [, options] )
                    await t[element.Keyword](element.LocatorType(element.LocatorValue))
                    logger.info(element.Keyword + element.LocatorType + element.LocatorValue +" - After test execution, actual test result should be rightClicked")
                    break;
                ...
                case "hover": //t.hover( selector [, options] )
                    await t[element.Keyword](element.LocatorType(element.LocatorValue))
                    logger.info(element.Keyword + element.LocatorType + element.Parameter +" - After test execution, actual test result should be hover the specific field")
                    break;
                ...
                case "setFilesToUpload": //t.setFilesToUpload( selector, filePath )
                    ...
                    logger.info(element.Keyword + element.LocatorType + element.Parameter +" - After test execution, actual test result should be uploaded files into the specific app")
                    break;
                ...
                case "drag": //t.drag( selector, dragOffsetX, dragOffsetY [, options] )
                    ...
                    logger.info(element.Keyword + element.LocatorType + element.Parameter +" - After test execution, actual test result should be draged element into the position")
                    break;
                default:
                    return;
            }
