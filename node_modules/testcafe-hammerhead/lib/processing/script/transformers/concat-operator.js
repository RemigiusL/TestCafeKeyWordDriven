...
const transformer = {
  ...
  condition: node => {
    ...
    if (left.type === _esotopeHammerhead.Syntax.MemberExpression) {
      ...
      if (left.computed) return left.property.type === _esotopeHammerhead.Syntax.Literal ? (0, _instrumented.shouldInstrumentProperty)(left.property.value) : true; // something.location
