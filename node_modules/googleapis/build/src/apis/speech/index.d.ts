...
export declare const VERSIONS: {
    ...
    v2beta: typeof speech_v2beta.Speech;
};
...
export declare function speech(version: 'v2beta'): speech_v2beta.Speech;
export declare function speech(options: speech_v2beta.Options): speech_v2beta.Speech;
